...
func PublicKeyToAddress(key *ecdsa.PublicKey) (Address, error) {
	return PublicKeyBytesToAddress(elliptic.Marshal(key, key.X, key.Y))
}

func PublicKeyBytesToAddress(key []byte) (Address, error) {
	if key == nil {
